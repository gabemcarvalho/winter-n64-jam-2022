...
namespace ThirdPersonCamera
{
    ...
    public class FreeForm : MonoBehaviour
    {
        ...
        [Tooltip("The angle where smart pivot starts")]
        public float yAngleSmartPivotBegin = 0.0f;
        ...
        public void LateUpdate()
        {
            ...
            if (!smartPivotInit && angle > yAngleSmartPivotBegin)
            {
                smartPivotInit = true;
                cameraController.DisableSmartPivot();
            }

            if ((!cameraController.smartPivot || angle > yAngleSmartPivotBegin) ||
